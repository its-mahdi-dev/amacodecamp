    ...
    <section>
        <div class="dashboard-content-wrap w-100">
            <div class="container-fluid">
                <div class="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between mb-5 text-start">
                    <div class="media media-card align-items-center">
                        <div class="media-img media--img media-img-md rounded-full">
                            <img class="rounded-full" src="/assets/images/img-loading.png" alt="Student thumbnail image"
                                id="userAvatar" />
                        </div>
                        ...
                        <div class="setting-body">
                            ...
                            <div class="media media-card align-items-center">
                                <div class="media-img media-img-lg me-4 bg-gray">
                                    <img class="me-3" src="/assets/images/img-loading.png" alt="avatar image"
                                        id="userAvatar2" />
                                </div>
                                <div class="media-body">
                ...
                <div class="row align-items-center dashboard-copyright-content py-4">
                    <div class="col-lg-6">
                        <p class="copy-desc">
                            ...
                            <a href="https://amacodecamp.ir">Ama codecamp</a>
                        </p>
                    </div>
                    <!-- end col-lg-6 -->
                </div>
