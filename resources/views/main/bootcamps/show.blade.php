                ...
                <div class="breadcrumb-content text-start">
                    ...
                    <div class="bread-btn-box pt-3">
                        <button class="btn theme-btn theme-btn-sm theme-btn-transparent lh-28 me-2 mb-2">
                            ...
                            <span class="swapping-btn" data-text-swap="Wishlisted" data-text-original="Wishlist">قائمة
                                الرغبات</span>
                        </button>
                        <button class="btn theme-btn theme-btn-sm theme-btn-transparent lh-28 me-2 mb-2"
                            data-bs-toggle="modal" data-bs-target="#shareModal">
                            <i class="la la-share me-1"></i>يشارك
                        </button>
                        <button class="btn theme-btn theme-btn-sm theme-btn-transparent lh-28 mb-2" data-bs-toggle="modal"
                            data-bs-target="#reportModal">
                            <i class="la la-flag me-1"></i>بلغ عن سوء معاملة
                        </button>
                    </div>
                </div>
                ...
                <div class="col-lg-8 pb-5">
                    <div class="course-details-content-wrap pt-90px">
                        <div class="course-overview-card bg-gray p-4 rounded">
                            <h3 class="fs-24 font-weight-semi-bold pb-3">ماذا ستتعلم؟</h3>
                            <ul class="generic-list-item overview-list-item">
                                <li>
                                    <i class="la la-check me-1 text-black"></i>تعلم مهارات Java
                                    الأساسية اللازمة للتقدم لشغل وظائف مطور جافا في 14 ساعة فقط.
                                </li>
                                <li>
                                    <i class="la la-check me-1 text-black"></i>كن قادرًا على
                                    إظهار فهمك لجافا لأصحاب العمل في المستقبل.
                                </li>
                                <li>
                                    <i class="la la-check me-1 text-black"></i>احصل على أساسيات
                                    جافا الأساسية للانتقال إلى إطار الربيع و جافا وتطوير ذكري
                                    المظهر والمزيد.
                                </li>
                                <li>
                                    <i class="la la-check me-1 text-black"></i>كن قادرًا على
                                    الجلوس واجتياز اختبار وحي جافا شهادة إذا اخترت ذلك.
                                </li>
                                <li>
                                    <i class="la la-check me-1 text-black"></i>تعلم "أفضل
                                    الممارسات" في مجال تطوير برامج جافا من مطور جافا محترف عمل
                                    في اللغة لمدة 18 عامًا.
                                </li>
                                <li>
                                    <i class="la la-check me-1 text-black"></i>احصل على الكفاءة
                                    في Java 8 و Java 11.
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="course-overview-card bg-gray p-4 rounded">
                            <h3 class="fs-16 font-weight-semi-bold">
                                برعاية
                                <a href="for-business.html" class="text-color hover-underline">إحضار للأعمال</a>مجموعة
                            </h3>
                        </div>
                        <!-- end course-overview-card -->
                        <div class="course-overview-card">
                            <h3 class="fs-24 font-weight-semi-bold pb-3">متطلبات</h3>
                        ...
                        <div class="course-overview-card border border-gray p-4 rounded">
                            <h3 class="fs-20 font-weight-semi-bold">تثق أفضل الشركات في</h3>
                            <p class="fs-15 pb-1">
                                احصل على وصول فريقك إلى أكثر من 5000 دورة تدريبية في Aduca
                            </p>
                            <div class="pb-3">
                                <img width="85" class="me-3" src="images/sponsor-img.png" alt="company logo" />
                                <img width="80" class="me-3" src="images/sponsor-img2.png" alt="company logo" />
                                <img width="80" class="me-3" src="images/sponsor-img3.png" alt="company logo" />
                                <img width="70" class="me-3" src="images/sponsor-img4.png" alt="company logo" />
                            </div>
                            <a href="for-business.html" class="btn theme-btn theme-btn-sm">جرب Aduca للأعمال</a>
                        </div>
                        <!-- end course-overview-card -->
                        <div class="course-overview-card">
                        ...
                        <div class="course-overview-card">
                            <div class="curriculum-header d-flex align-items-center justify-content-between pb-4">
                                <h3 class="fs-24 font-weight-semi-bold">محتوى الدورة</h3>
                                <div class="curriculum-duration fs-15">
                                    ...
                                    <span class="curriculum-total__hours"><strong
                                            class="text-black font-weight-semi-bold">مجموع الساعات:</strong>
                                        02:35:47</span>
                                </div>
                            </div>
                                                    ...
                                                    <li>
                                                        <a href="#"
                                                            ...
                                                            <span>
                                                                ...
                                                                كلمات تمهيدية
                                                                <span class="ribbon ms-2 fs-13">معاينة</span>
                                                            </span>
                                                            <span>02:27</span>
                                                        </a>
                                                    </li>
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="headingThree">
                                            <button
                                                ...
                                                <i class="la la-minus"></i>
                                                استنتاج
                                                <span class="fs-15 text-gray font-weight-medium">1 محاضرات</span>
                                            </button>
                                        </div>
                                                    ...
                                                    <li>
                                                        <a href="#"
                                                            ...
                                                            <span>
                                                                <i class="la la-play-circle me-1"></i>
                                                                استنتاج
                                                                <span class="ribbon ms-2 fs-13">يشاهد</span>
                                                            </span>
                                                            <span>02:27</span>
                                                        </a>
                                                    </li>
                                ...
                                <div class="media media-card align-items-center">
                                    ...
                                    <div class="media-body">
                                        <div class="review-bars d-flex align-items-center mb-2">
                                            <div class="review-bars__text">5 النجوم</div>
                                        ...
                                        <!-- end review-bars -->
                                        <div class="review-bars d-flex align-items-center mb-2">
                                            <div class="review-bars__text">4 النجوم</div>
                                            <div class="review-bars__fill">
                                                <div class="skillbar-box">
                                        ...
                                        <!-- end review-bars -->
                                        <div class="review-bars d-flex align-items-center mb-2">
                                            <div class="review-bars__text">3 النجوم</div>
                                            <div class="review-bars__fill">
                                                <div class="skillbar-box">
                                        ...
                                        <!-- end review-bars -->
                                        <div class="review-bars d-flex align-items-center mb-2">
                                            <div class="review-bars__text">2 النجوم</div>
                                            <div class="review-bars__fill">
                                                <div class="skillbar-box">
                                        ...
                                        <!-- end review-bars -->
                                        <div class="review-bars d-flex align-items-center mb-2">
                                            <div class="review-bars__text">1 النجوم</div>
                                            <div class="review-bars__fill">
                                                <div class="skillbar-box">
                        ...
                        <!-- end course-overview-card -->
                        <div class="course-overview-card pt-4">
                            <h3 class="fs-24 font-weight-semi-bold pb-4">المراجعات</h3>
                            <div class="review-wrap">
                                    ...
                                    <form method="post" class="me-3 flex-grow-1">
                                        <div class="form-group">
                                            <input class="form-control form--control ps-3" type="text" name="search"
                                                placeholder="بحث في الاستعراضات" />
                                            <span class="la la-search search-icon"></span>
                                        </div>
                                    </form>
                                    <div class="select-container select2-full-wrapper mb-3">
                                        <select class="select-container-select">
                                            <option value="all-rating">كل التصنيفات</option>
                                            <option value="five-star">خمس نجوم</option>
                                            <option value="four-star">أربعة النجوم</option>
                                            <option value="three-star">ثلاثة النجوم</option>
                                            <option value="two-star">اثنين النجوم</option>
                                            <option value="one-star">واحد نجمة</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <span class="d-block lh-18 pb-2">قبل شهر</span>
                                        <p class="pb-2">
                                            هذه واحدة من أفضل الدورات التي أخذتها في احضر إنه مكتمل
                                            للغاية ، وقد جعل التعلم المستمر حول قواعد بيانات Java و
                                            SQL أيضًا.
                                        </p>
                                        <div class="helpful-action">
                                            <span class="d-block fs-13">هل كانت هذه المراجعة مفيدة؟</span>
                                            <button class="btn">نعم</button>
                                            <button class="btn">لا</button>
                                            <span class="btn-text fs-14 cursor-pointer ps-1" data-bs-toggle="modal"
                                                data-bs-target="#reportModal">تقرير</span>
                                        </div>
                                    </div>
                                </div>
                                <!-- end media -->
                                <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <span class="d-block lh-18 pb-2">منذ 1 شهر</span>
                                        <p class="pb-2">
                                            هذه واحدة من أفضل الدورات التي أخذتها في احضر إنه مكتمل
                                            للغاية ، وقد جعل التعلم المستمر حول قواعد بيانات Java و
                                            SQL أيضًا.
                                ...
                                <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <span class="d-block lh-18 pb-2">منذ 2 شهر</span>
                                        <p class="pb-2">
                                            هذه واحدة من أفضل الدورات التي أخذتها في احضر إنه مكتمل
                                            للغاية ، وقد جعل التعلم المستمر حول قواعد بيانات Java و
                                            SQL أيضًا.
