                    ...
                    <div class="col-xl-5 col-lg-6">
                        <div class="banner__content">
                            <h3 class="title tg-svg" data-aos="fade-right" data-aos-delay="400">
                                ...
                                <br>و با کلی <b>جایزه</b> انجام شه
                            </h3>
                            <p data-aos="fade-right" data-aos-delay="600">با بوتکمپ های آما، فقط قرار نبست یاد بگیری. میتونی تو کلی چالش و مسابقه هم شرکت کنی</p>
                            <div class="banner__btn-wrap" data-aos="fade-right" data-aos-delay="800">
                                <a href="contact.html" class="btn arrow-btn">بزن بریم<img src="assets/img/icons/right_arrow.svg" alt="img" class="injectable"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
